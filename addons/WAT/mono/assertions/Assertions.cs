...
namespace WAT
{
    public class Assertions : Reference
    {
        ...
        public void SignalWasEmitted(Object emitter, string signal, string context = "")
        {
            Output(Signal.WasEmitted(emitter, signal, context));
        }

        public void SignalWasEmittedXTimes(Object emitter, string signal, int times, string context = "")
        {
            Output(Signal.WasEmittedXTimes(emitter, signal, times, context));
        }

        public void SignalWasNotEmitted(Object emitter, string signal, string context = "")
        {
            Output(Signal.WasNotEmitted(emitter, signal, context));
        }

        public void SignalWasEmittedWithArguments(Object emitter, string signal, GDArray args, string context = "")
        {
        ...
        public void ObjectHasMeta(Object obj, string meta, string context = "")
        {
            Output(ObjectX.HasMeta(obj, meta, context));
        }

        public void ObjectDoesNotHaveMeta(Object obj, string meta, string context = "")
        {
            Output(ObjectX.DoesNotHaveMeta(obj, meta, context));
        }

        public void ObjectHasMethod(Object obj, string method, string context = "")
        {
            Output(ObjectX.HasMethod(obj, method, context));
        }

        public void ObjectDoesNotHaveMethod(Object obj, string method, string context = "")
        {
            Output(ObjectX.DoesNotHaveMethod(obj, method, context));
        }

        public void ObjectIsQueuedForDeletion(Object obj, string context = "")
        {
            Output(ObjectX.IsQueuedForDeletion(obj, context));
        }

        public void ObjectIsNotQueuedForDeletion(Object obj, string context = "")
        {
        ...
        public void ObjectIsNotConnected(Object sender, string signal, Object receiver, string method,
            string context = "")
        {
