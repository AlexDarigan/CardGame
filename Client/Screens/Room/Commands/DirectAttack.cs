...
namespace CardGame.Client.Commands
{
    public class DirectAttack: Command
    {
        ...
        protected override void Setup(Room room)
        {
            ...
            room.Effects.InterpolateCallback(card, 0.2f, nameof(Card.LookAt), heart.Translation);
            room.Effects.InterpolateProperty(card, nameof(Card.Translation), card.Translation, heart.Translation, 0.2f, 
                Tween.TransitionType.Linear, Tween.EaseType.InOut, 0.3f);
            
            room.Effects.InterpolateProperty(card, nameof(Card.Translation), heart.Translation, card.Translation,
